...
- generating concise deterministic recommendation explanations from verified constraint evidence and supported soft matches;
...
- [Local watchlist](docs/local-watchlist.md)
- [Analytics event taxonomy](docs/event-taxonomy.md)
- [Analytics property allowlist](docs/analytics-property-allowlist.md)
- [Picker funnel dashboard](docs/picker-funnel-dashboard.md)
- [Recommendation decision dashboard](docs/recommendation-decision-dashboard.md)
